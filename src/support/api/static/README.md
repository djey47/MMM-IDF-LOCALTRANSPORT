...
Make sure to replace unicode characters \uxxxx with simplified values (a,e,u etc...) to give better search results. normalize.js script may help you:
`node normalize.js <ref file.json>`
